...
class testDAO 
{
	...
	function displayPage() 
	{
		...
		{	
			case 'view':
				require("template/pages/test_view.php");
				break;
...
HTML;
	...
	function add() 
	{
		...
		$response->SetFormSubmitResponse(__('Layout Details Changed.'), true, sprintf("index.php?p=test&layoutid=%d&modify=true", $id));
		$response->Respond();
	}
...
END;
				...
				if ($edit_permissions) 
				{
					...
					$output .= '<button href="index.php?p=test&modify=true&layoutid=' . $layoutid . '" onclick="window.location = $(this).attr(\'href\')"><span>Design</span></button>';
					$output .= '<button class="XiboFormButton" href="index.php?p=test&q=displayForm&modify=true&layoutid=' . $layoutid . '"><span>Edit</span></button>';
					$output .= '<button class="XiboFormButton" href="index.php?p=test&q=CopyForm&layoutid=' . $layoutid . '&oldlayout=' . $layout . '"><span>' . $msgCopy . '</span></button>';
					$output .= '<button class="XiboFormButton" href="index.php?p=test&q=delete_form&layoutid=' . $layoutid . '"><span>Delete</span></button>';
					$output .= '</td>';*/
				}
				else 
				{
