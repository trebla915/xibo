...
class layoutpDAO 
{
	...
	function displayPage() 
	{
		...
		{	
			case 'view':
				require("template/pages/layoutp_view.php");
				break;
				
			case 'edit':
				require("template/pages/layoutp_edit.php");
				break;
	...
	function LayoutFilter() 
	{
		...
		<div class="FilterDiv" id="LayoutFilter">
			<form onsubmit="return false">
				...
				<input type="hidden" name="q" value="LayoutGrid2">
		...
		<div id="canvas">
			...
			<div id="timeline" style="clear:left; float:none;">
				<div id="timeline_ctl" style="$timelineCtlMargin width:790px; position:relative; overflow-y:hidden; overflow-x:scroll;" layoutid="$this->layoutid" regionid="$regionid">
					<div style="width:$tableWidthPx; height:2080px;">
						$mediaHtml
					</div>
				</div>
...
END;
    ...
    //Stuff for the library stuff
    public function LibraryFilter()
    {
    	//$lib = new contentDAO($this->$db, $this->$user);
