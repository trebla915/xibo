...
END;
		...
		<form class="XiboForm" method="post" action="index.php?p=module&mod=$this->type&q=Exec&method=AddMedia">
			...
			<table width="100%">
				...
				<tr>
		    		<td><label for="duration" title="The duration in seconds this video should be displayed (may be overridden on each layout)">Duration (s)<span class="required">*</span></label></td>
